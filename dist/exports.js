...
// src/ApolloClientWithGQL.js
var ApolloClientWithGQL = class extends ApolloClient {
  /**
   ...
   */
  query(options, ...args) {
    return ApolloClient.prototype.query.apply(
      this,
      [
        {
          ...options,
  ...
  subscribe(options, ...args) {
    return ApolloClient.prototype.subscribe.apply(
      this,
      [
        {
          ...options,
   ...
   */
  mutate(options, ...args) {
    return ApolloClient.prototype.mutate.apply(
      this,
      [
        {
          ...options,
...
export {
  createGraphQLClient_default as createGraphQLClient,
  createGraphQLLinks_default as createGraphQLLinks,
